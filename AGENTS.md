# AGENTS.md — HOMS (Healthcare Operations Management System)

This file is the primary guidance file loaded by Codex for this repository.
...
| `prolific-hr-app/docs/Project Docs/AGENTS.md` | Detailed implementation rules for the main app |
...
- **External APIs:** BambooHR, JazzHR, WordPress/LearnDash, JotForm, Anthropic Codex API
- **Import alias:** `@/` → `src/`
